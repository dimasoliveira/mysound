                    ...
                    <div class="col s3 m3">
                        ...
                        <div class="card hoverable">
                            ...
                            <div class="card-image waves-effect waves-block waves-light">
                                ...
                                <img src="@if (!empty(Storage::exists($audio_post->coverart) )) {{ Storage::url($audio_post->coverart) }} @else {{ Storage::url('public/defaults/coverart.png') }}  @endif" class="activator circle z-depth-2 responsive-img" style="height: auto;width: 100%">
