                                ...
                                <div class="card-image waves-effect waves-block waves-light">
                                   ...
                                   <div class="card-stacked">
                                    <div class="card-content">
                                        ...
                                        <p class="right blue-text">{{  count($post->likes).' Likes' }}</p>
                                    </div>
                                    ...
                                    <div class="card-action" style="padding-top: 0px;padding-bottom: 0px;">
                                        ...
                                        <div class="input-field col s11">
                                            ...
                                            <div class="input-field col s1">
                                                {!! Form::open(['route'=> ['like.request',$post->id],'method' => 'POST', 'id' => 'likeForm']) !!}

                                            @if (\Illuminate\Support\Facades\DB::table('likes')->where('user_id', Auth::user()->id)->where('audio_id', $post->id)->exists())
                                                    <button type="submit" role="button" id="likeButton" class="btn-floating btn-medium waves-effect waves-light blue right"><i class="material-icons">favorite</i></button>
                                                @else
                                                    <button type="submit" role="button" id="likeButton" class="btn-floating btn-medium waves-effect waves-light white blue-text right"> <i class="material-icons" style="color: #2196F3;">favorite_border</i></button>
                                                @endif
                                                {{ Form::close() }}
                                        </div>
                                        </div>
