                    ...
                    <div class="card horizontal activator">
                        ...
                        <div class="card-stacked">
                            <div class="card-content">
                                ...
                                <p class="card-title grey-text text-darken-4">{{ $audio->title }} @if ($audio->explicit)<i title="This song contains strong language." class="tiny material-icons blue-text">explicit</i> @endif </p>
                                <p>Artist: {{ $audio->artist }}</p>  <p class="blue-text right">{{  count($audio->likes).' Like(s)' }}</p>
                                <p>Album: {{ $audio->album->name }}</p>
                                <p>Genre: {{ $audio->genre->name }}</p>
